...
namespace Backend
{
    public class Utility
    {
        ...
        public static GenericPopup MakeNewGenericPopup(string titleText, string messageText, bool showTwoButtons, string buttonOneText = "Ok", System.Action okButtonCallback = null, string buttonTwoText = "Cancel", System.Action cancelButtonCallback = null)
        {
            ...
            popup.OkButton.onClick.AddListener(() => okButtonCallback.Invoke());
            popup.CancelButton.onClick.AddListener(() => cancelButtonCallback.Invoke());
        ...
        public static IEnumerator LoadScene(string sceneName)
        {
            ...
            Debug.Log(sceneName + " -- ABOUT TO LOAD --");
        ...
        public static IEnumerator WebRequest(string url, System.Action<byte[]> callback = null)
        {
            ...
            Debug.Log("Sending web request to " + httpsUrl + "...");
            ...
            if (www == null)
            {
                Debug.LogError("Error in request to " + httpsUrl + "!\n Unable to create www object!");
            }
            ...
            {
                Debug.Log("Successful web request to " + httpsUrl);
            }
        ...
        public static DateTime ConvertTimestampToDatetime(string timestamp)
        {
            ...
            {
                Debug.LogWarning("The timestamp passed into Utility.ConvertTimestampToDatetime is null or empty!");
            }

            DateTime newDateTime = DateTime.Now;
            if (!DateTime.TryParse(timestamp, out newDateTime))
            {
                Debug.LogWarning("Unable to parse '" + timestamp + "' as a DateTime! Using DateTime.Now!");
            }
            return newDateTime;
        }
        ...
        public static string ConvertDateTimeToTimestamp(DateTime date)
        {
            ...
            //Debug.Log("ConvertDateTimeToTimestamp: " + convertedDate, Debug.MessageFilter.GameData);
        ...
        public static string ConvertStringToBase64(string input)
        {
            ...
            catch (Exception e)
            {
                ...
                Debug.LogError("Unable to convert " + input + " to base 64 string! " + e.Message);
            }
            return "";
        }
        ...
        public static bool TryParseEnum<T>(string inputValue, out T outputValue)
        {
            ...
            {
                Debug.LogError("Unable to parse enum! " + e.Message);
            }
