...
namespace VRInput
{
    ...
    public class SVRInput : MonoBehaviour
    {
        ...
        public event System.Action<SwipeDirection> OnSwipe;                // Called every frame passing in the swipe, including if there is no swipe.
        public event System.Action OnClick;                                // Called when Fire1 is released and it's not a double click.
        public event System.Action OnDown;                                 // Called when Fire1 is pressed.
        public event System.Action OnUp;                                   // Called when Fire1 is released.
        public event System.Action OnDoubleClick;                          // Called when a double click is detected.
        public event System.Action OnCancel;                               // Called when Cancel is pressed.
