...
public class SVRRaycaster : MonoBehaviour {
    ...
    [SerializeField] private VRInput.SVRInput m_VrInput;                     // Used to call input based events on the current VRInteractiveItem.
    ...
    private SVRInteractable m_CurrentInteractible;                //The current interactive item
    private SVRInteractable m_LastInteractible;                   //The last interactive item


    // Utility for other classes to get the current interactive item
    public SVRInteractable CurrentInteractible
    {
    ...
    private void EyeRaycast()
    {
        ...
        {
            SVRInteractable interactible = hit.collider.GetComponent<SVRInteractable>(); //attempt to get the VRInteractiveItem on the hit object
